<?php
  ...
  class AllegroWebAPI {
      ...
      public function Login($Encode = false) {
          ...
          if (!$Encode) {
              $session = $this->_client->doLogin($this->_config['allegro_login'], $this->_config['allegro_password'], self::COUNTRY_CODE, $this->_config['allegro_key'], $version['ver-key']);
          } else {
              ...
              $session = $this->_client->doLoginEnc($this->_config['allegro_login'], $password, self::COUNTRY_CODE, $this->_config['allegro_key'], $version['ver-key']);
          }
