<?php
class ControllerEbayPlay extends Controller {
    ...
    public function index(){
        ...
        $this->data['breadcrumbs'][] = array(
            'href' => HTTPS_SERVER . 'index.php?route=ebay/play&token=' . $this->session->data['token'],
        ...
        $this->data['links_settings'] = HTTPS_SERVER . 'index.php?route=ebay/play/settings&token=' . $this->session->data['token'];
    ...
    protected function validate(){
        if (!$this->user->hasPermission('modify', 'ebay/play')) {
    ...
    public function settings(){
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && ($this->validate())) {
            ...
            $this->redirect(HTTPS_SERVER . 'index.php?route=ebay/play&token=' . $this->session->data['token']);
        }
        ...
        $this->data['breadcrumbs'][] = array(
            'href' => HTTPS_SERVER . 'index.php?route=ebay/openbay&token=' . $this->session->data['token'],
            'text' => $this->language->get('text_obp_play'),
            'separator' => ' :: '
        );

        $this->data['breadcrumbs'][] = array(
            'href' => HTTPS_SERVER . 'index.php?route=ebay/play/settings&token=' . $this->session->data['token'],
            'text' => $this->language->get('text_settings'),
            'separator' => ' :: '
        );

        $this->data['action'] = HTTPS_SERVER . 'index.php?route=ebay/play/settings&token=' . $this->session->data['token'];
        $this->data['cancel'] = HTTPS_SERVER . 'index.php?route=ebay/play&token=' . $this->session->data['token'];
