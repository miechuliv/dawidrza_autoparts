...
class ControllerPaymentBankTransfer extends Controller {
	...
	public function index() {
        ...
        if (isset($this->request->post['bank_transfer_rabat_percent'])) {
            $this->data['bank_transfer_rabat_percent'] = $this->request->post['bank_transfer_rabat_percent'];
        } else {
            $this->data['bank_transfer_rabat_percent'] = $this->config->get('bank_transfer_rabat_percent');
        }
