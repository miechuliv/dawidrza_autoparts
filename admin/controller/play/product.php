...
class ControllerPlayProduct extends Controller {
    public function pricingReport(){
        if ($this->checkConfig() == true) {
            ...
            $this->data['cancel']   = HTTPS_SERVER . 'index.php?route=catalog/product&token=' . $this->session->data['token'];
            ...
            $this->redirect(HTTPS_SERVER . 'index.php?route=catalog/product&token=' . $this->session->data['token']);
        }
    }
