...
// Heading
$_['heading_title']             = 'Kreditkarte';

// Text
$_['text_giropay_credit']       = '<a onclick="window.open(\'http://www.giropay.de/\');"><img src="view/image/payment/giropay.png" alt="giropay.de" title="giropay.de" style="border: 1px solid #EEEEEE;" /></a>';
?>