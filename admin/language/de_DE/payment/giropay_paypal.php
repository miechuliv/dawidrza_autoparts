...
// Text
$_['text_giropay_paypal']       = '<a onclick="window.open(\'http://www.giropay.de/\');"><img src="view/image/payment/giropay.png" alt="giropay.de" title="giropay.de" style="border: 1px solid #EEEEEE;" /></a>';
?>