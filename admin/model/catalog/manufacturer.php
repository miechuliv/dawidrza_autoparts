...
class ModelCatalogManufacturer extends Model {
    public function addManufacturer($data) {
        ...
        if (isset($data['manufacturer_group'])) {
            $this->db->query("UPDATE " . DB_PREFIX . "manufacturer SET manufacturer_group = '" . (int)$data['manufacturer_group'] . "' WHERE manufacturer_id = '" . (int)$manufacturer_id . "'");
        }
        ...
        {
            $this->db->query("UPDATE " . DB_PREFIX . "manufacturer SET  manu_description = '".$this->db->escape($data['description'])."' WHERE manufacturer_id = '" . (int)$manufacturer_id . "'");
    ...
    public function editManufacturer($manufacturer_id, $data) {
        $this->db->query("UPDATE " . DB_PREFIX . "manufacturer SET name = '" . $this->db->escape($data['name']) . "', sort_order = '" . (int)$data['sort_order'] . "',  follow = '".(int)$data['follow']."' WHERE manufacturer_id = '" . (int)$manufacturer_id . "'");
