                            ...
                            <td>
                                <?php foreach ($marketplaces as $mp) { ?>
                                    <div style="text-align: center; float: left; margin-right: 20px;">
                                        ...
                                        <input id="default_marketplace_<?php echo $mp['code'] ?>" <?php  if (in_array($mp['id'], $default_listing_marketplace_ids)) { ?> checked="checked" <?php }  ?> type="radio" name="openbay_amazon_default_listing_marketplace_ids[]" value="<?php echo $mp['id'] ?>">
                                    </div>
                                <?php } ?>
                            </td>
                        </tr>
