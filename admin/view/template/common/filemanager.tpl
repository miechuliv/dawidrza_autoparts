...
<script src="view/javascript/project_specyfic/dropzone.js"></script>
<style type="text/css">
body {
	padding: 0;
	margin: 0;
...
<div id="container">
  ...
  <div id="uploader">
      <form action="index.php?route=common/filemanager/massupload&token=<?php echo $token; ?>"
            class="dropzone"
            id="my-awesome-dropzone">
          <div class="dropzone-previews"></div>
           <input type="hidden" name="directory" />
          <button type="submit">Zapisz wszystkie pliki na serwer!</button>
            </form>
  </div>
</div>
...
$(document).ready(function() { 
    ...
    $('#search').bind('click', function() {
           ...
           var name = $('input[name="search"]').val();
                ...
                $.ajax({
                    url: 'index.php?route=common/filemanager/search&token=<?php echo $token; ?>&name=' + encodeURIComponent(name),
                    dataType: 'json',
			...
			onselect: function (NODE, TREE_OBJ) {
				$.ajax({
					...
					success: function(json) {
                        ...
                        // dla doprboxa
                        $('#uploader input[name="directory"]').val($(NODE).attr('directory'));
                       //
    ...
    Dropzone.options.myAwesomeDropzone = { // The camelized version of the ID of the form element
        ...
        init: function() {
            ...
            $('.dz-message span').html('Przeciągnij tutaj pliki które chcesz wgrać na serwer');
            ...
            this.on("successmultiple", function(files, response) {
                ...
                $.ajax({
                    url: 'index.php?route=common/filemanager/files&token=<?php echo $token; ?>',
                    type: 'post',
                    data: 'directory=' + encodeURIComponent($('input[name="directory"]').val()),
                    dataType: 'json',
                    success: function(json) {
                        html = '<div>';
                        ...
                        // dla doprboxa
                        $('#uploader input[name="directory"]').val($('input[name="directory"]').val());
                        //
                ...
                this.removeAllFiles();
                alert('pliki zostały załadowane na serwer');
            });
