        ...
        <tbody>
          ...
          <tr>
            <td style="text-align: center;"><?php if ($szablon['selected']) { ?>
              <input type="checkbox" name="selected[]" value="<?php echo $szablon['debay_template_id']; ?>" checked="checked" />
              <?php } else { ?>
              <input type="checkbox" name="selected[]" value="<?php echo $szablon['debay_template_id']; ?>" />
              <?php } ?></td>
