        ...
        <div class="content">
            ...
            <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
                ...
                <div id="tab-settings">
                    <table class="form">
                        <tr>
                            <td ><?php echo $field_openbaypro_disable_homemsg; ?></td>
                            <td>
...
<script type="text/javascript">
    ...
    function ftpTest(){
        $.ajax({
            url: 'index.php?route=extension/ebay/ftpTestConnection&token='+token,
            type: 'post',
    ...
    function runPatch(){
        $.ajax({
            url: 'index.php?route=extension/ebay/runPatch&token='+token,
            type: 'post',
            dataType: 'json',
            beforeSend: function(){
                $('#runPatch').hide();
    ...
    function updateModule(){
        $.ajax({
            url: 'index.php?route=extension/ebay/ftpUpdateModule&token='+token,
            type: 'post',
            data: $('.ftpsetting').serialize(),
            dataType: 'json',
            beforeSend: function(){ 
    ...
    function clearFaq(){
        $.ajax({
            url: 'index.php?route=extension/ebay/faqClear&token='+token,
            beforeSend: function(){
                $('#clearFaq').hide();
                $('#imageClearFaq').show();
            },
