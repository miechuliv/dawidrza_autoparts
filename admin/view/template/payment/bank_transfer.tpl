    ...
    <div class="content">
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="form">
          ...
          <tr>
              <td>Włącz rabat dla tej metody płatności</td>
              <td>
                  <select name="bank_transfer_rabat_status">
          ...
          <tr>
              <td>Procent rabatu ( maks. 10 % )</td>
              <td><input type="text" name="bank_transfer_rabat_percent" value="<?php echo $bank_transfer_rabat_percent; ?>" size="1" /></td>
          </tr>
        </table>
      </form>
    </div>
