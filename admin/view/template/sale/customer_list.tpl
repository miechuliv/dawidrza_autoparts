...
<div id="content">
  ...
  <div class="box">
    <div class="heading">
      <h1><span class="fa fa-users"></span> <?php echo $heading_title; ?></h1>
        ...
        <table class="list">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="left"><select class="long" onchange="((this.value !== '') ? window.open('index.php?route=sale/customer/login&token=<?php echo $token; ?>&customer_id=<?php echo $customer['customer_id']; ?>&store_id=' + this.value) : null); this.value = '';">
