...
class ControllerCheckoutCheckout extends Controller { 
    ...
    public function validate()
    {
        ...
        if(!$json)
        {
            ...
            if (isset($this->request->post['auto_account_newsletter'])) {
                $this->session->data['auto_account_newsletter'] = $this->request->post['auto_account_newsletter'];
            }
            // payemnt validation
        ...
        if(!$redirect)
        {
            ...
            if(isset($this->session->data['auto_account']))
            {
                $uData = array(
                    ...
                    'show_cred_email' => '1',
                    'newsletter' => isset($this->session->data['auto_account_newsletter'])?$this->session->data['auto_account_newsletter']:false,
