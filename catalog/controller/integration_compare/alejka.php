<?php
class ControllerIntegrationCompareAlejka extends Controller {
	public function index() {
		if ($this->config->get('alejka_status')) {
			if ($this->request->get['password'] == $this->config->get('alejka_private_key')) {
				...
				$this->model_integration_compare_compareprices->saveLastDate('alejka');
