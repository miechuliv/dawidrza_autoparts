<?php
class ControllerIntegrationCompareCeneo extends Controller {
	public function index() {
		if ($this->config->get('ceneo_status')) {
			if ($this->request->get['password'] == $this->config->get('ceneo_private_key')) {
				...
				$this->model_integration_compare_compareprices->saveLastDate('ceneo');
