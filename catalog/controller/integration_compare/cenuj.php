<?php
class ControllerIntegrationCompareCenuj extends Controller {
	public function index() {
		if ($this->config->get('cenuj_status')) {
			if ($this->request->get['password'] == $this->config->get('cenuj_private_key')) {
				...
				$this->model_integration_compare_compareprices->saveLastDate('cenuj');
