<?php
class ControllerIntegrationCompareHarpagon extends Controller {
	public function index() {
		if ($this->config->get('harpagon_status')) {
			if ($this->request->get['password'] == $this->config->get('harpagon_private_key')) {
				...
				$this->model_integration_compare_compareprices->saveLastDate('harpagon');
