<?php
class ControllerIntegrationCompareKupujemy extends Controller {
	public function index() {
		if ($this->config->get('kupujemy_status')) {
			if ($this->request->get['password'] == $this->config->get('kupujemy_private_key')) {
				...
				$this->model_integration_compare_compareprices->saveLastDate('kupujemy');
