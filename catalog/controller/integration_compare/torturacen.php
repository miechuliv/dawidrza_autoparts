<?php
class ControllerIntegrationCompareTorturacen extends Controller {
	public function index() {
		if ($this->config->get('torturacen_status')) {
			if ($this->request->get['password'] == $this->config->get('torturacen_private_key')) {
				$output  = '<?xml version="1.0" encoding="UTF-8" ?>';
				$output .= '<!DOCTYPE tortura SYSTEM "http://www.tortura.pl/integracja/tortura.dtd">';
				$output .= '<tortura>';
				...
				$this->model_integration_compare_compareprices->saveLastDate('torturacen');
