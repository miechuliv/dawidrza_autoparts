<?php
class ControllerIntegrationCompareTotu extends Controller {
	public function index() {
		if ($this->config->get('totu_status')) {
			if ($this->request->get['password'] == $this->config->get('totu_private_key')) {
				...
				$this->model_integration_compare_compareprices->saveLastDate('totu');
