<?php
//-----------------------------------------
// Shipping Poczta Polska plus Opencart Module
// Version: 1.4.7 - 1.5.x
// Author: Altkomp PHU
// License: Commercial
...
// http://www.altkomp.pl/
//-----------------------------------------
class ModelShippingPocztaplus extends Model {
	private $name = '';
	...
	public function getQuote($address) {
        ...
        $this->load->language('shipping/pocztaplus');
		...
		foreach ($geozones->rows as $result) {
   			if ($this->config->get('pocztaplus_' . $result['geo_zone_id'] . '_status')) {
			...
			if ($status) {
				...
				$keyword = $this->config->get('pocztaplus_' . $result['geo_zone_id'] . '_filter');
