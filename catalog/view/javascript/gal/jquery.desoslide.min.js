        ...
        var app = {
            ...
            */
            addControls: function() {
                ...
                * Controls buttons
                */
                var $prev   = '<a href="javascript:void(0);" id="con-prev"><span class="desoSlide-controls prev"></span></a>';
                var $pause  = '';
                var $play   = '';
                var $next   = '<a href="javascript:void(0);" id="con-next"><span class="desoSlide-controls next"></span></a>';
            ...
            */
            events: function() {
                ...
                */
				...
				$('#con-prev').on('click',function(){ $(p.main.container).trigger('prev.desoslide'); });
				$('#con-next').on('click',function(){ $(p.main.container).trigger('next.desoslide'); });
