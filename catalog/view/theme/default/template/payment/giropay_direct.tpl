...
<div class="content">
  <table class="form" style="margin-bottom: 0;">
    ...
    <tr>
      ...
      <td><input type="text" id="bankaccount" name="bankaccount" value="" /></td>
    </tr>
  </table>
</div>
<div class="buttons">
...
$('#button-confirm').bind('click', function() {
	$.ajax({
		url: 'index.php?route=payment/giropay_direct/getParameters',
		type: 'post',
		data: 'bankcode=' + $('#bankcode').val() + '&bankaccount=' + $('#bankaccount').val(),
		dataType: 'json',
		beforeSend: function() {
